...
import net.zypro.istrone.ui.VideoPreviewActivity;
import net.zypro.istrone.ui.recorder.ProgressView.State;
import net.zypro.istrone.util.AppConfig;
import net.zypro.istrone.util.TimeUtils;
...
public class FFmpegRecorderActivity extends Activity implements OnClickListener, OnTouchListener {
	...
	private int currentResolution = RecorderConfig.RESOLUTION_MEDIUM_VALUE;
	...
	private void initVideoRecorder() {
		videoPath=AppConfig.ExternalFile.VIDEO_DRAFT_PATH+TimeUtils.getExactTime()+".mp4";
		...
		fileVideoPath = new File(videoPath); 
		videoRecorder = new NewFFmpegFrameRecorder(videoPath, 480, 480, 1);
	...
	public class AsyncStopRecording extends AsyncTask<Void,Integer,Void>{
		...
		private void getFirstCapture(byte[] data){
			...
			String captureBitmapPath = AppConfig.ExternalFile.VIDEO_DRAFT_PATH+TimeUtils.getExactTime()+".jpg";

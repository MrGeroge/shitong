package net.zypro.istrone.ui.recorder;
...
public class Util {
	...
	public static RecorderParameters getRecorderParameter(int currentResolution)
	{
		...
		if(currentResolution ==  RecorderConfig.RESOLUTION_HIGH_VALUE)
		{
			parameters.setAudioBitrate(128000);
			parameters.setVideoQuality(0);
		}
		else if(currentResolution ==  RecorderConfig.RESOLUTION_MEDIUM_VALUE)
		{
			parameters.setAudioBitrate(128000);
			parameters.setVideoQuality(5);
		}
		else if(currentResolution == RecorderConfig.RESOLUTION_LOW_VALUE)
		{
	...
	{
		int margin = 0;
		if(previewWidth <= RecorderConfig.RESOLUTION_LOW)
		{
			margin = (int) (screenWidth*0.12);
		}
		else if(previewWidth > RecorderConfig.RESOLUTION_LOW && previewWidth <= RecorderConfig.RESOLUTION_MEDIUM)
		{
			margin = (int) (screenWidth*0.08);
		}
		else if(previewWidth > RecorderConfig.RESOLUTION_MEDIUM && previewWidth <= RecorderConfig.RESOLUTION_HIGH)
		{
			margin = (int) (screenWidth*0.08);
		}
		return margin;
	...
	public static int setSelectedResolution(int previewHeight)
	{
		...
		if(previewHeight <= RecorderConfig.RESOLUTION_LOW)
		{
			selectedResolution = 0;
		}
		else if(previewHeight > RecorderConfig.RESOLUTION_LOW && previewHeight <= RecorderConfig.RESOLUTION_MEDIUM)
		{
			selectedResolution = 1;
		}
		else if(previewHeight >RecorderConfig.RESOLUTION_MEDIUM && previewHeight <= RecorderConfig.RESOLUTION_HIGH)
		{

		...
		<div class="row">
            <div class="span2">								
				<ul id="main-nav" class="nav nav-tabs nav-stacked">					
					...
					<li>
						<a href="<%=request.getContextPath() %>/admin-video-passStatus-no.jsp">
							<i class="icon-remove"></i>
							未审核
						</a>
					</li>	
                         <li>
						<a href="<%=request.getContextPath() %>/adminVideo/change-yes-no?to=passStatus-yes">
							<i class="icon-ok"></i>
							已审核
				...
				<%  List<Video> videosNoStatusList=(List<Video>)session.getAttribute("videosNoStatusList");
					...
					<button class="btn btn-small btn-info" data-toggle="modal" data-target="#myModal">审核</button>														
									  <!-- Modal -->
                                    ...
                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                                      <h4 id="myModalLabel" class="page-title">审核视频</h4>
                                     </div>
								...
								<video width="320" height="240" controls="controls">
                                 ...
                                 <source src="<%=video.getUrl() %>"  type="video/ogg" />
										...
										<div class="control-group">											
											...
											<div class="controls">
												<input type="text" class="input-medium " id="videoDesc" name="videoDesc" /></div> <!-- /controls -->				
										</div> <!-- /control-group -->
								  </form>
                             </div>
					 ...
					 <div class="btn-group">
                            ...
                            <a href="<%=request.getContextPath() %>/adminVideo/passStatus?videoId=<%=video.getId()%>" class="btn btn-small btn-success">通过</a>
                            <a href="<%=request.getContextPath() %>/adminVideo/delete?videoId=<%=video.getId()%>&&to=passStatus-no" class="btn btn-small btn-danger">删除</a>
                        </div>                   
